(function (node_crypto, require$$0, require$$3, require$$5, require$$2) {
    'use strict';
    ...
    const getCookieOptions = (cookieOptions, setDefault) => {
        const options = {};
        ...
        cookieOptionKeys.forEach((option) => {
            if (setDefault) {
    ...
    const getCookieString = (cookie, cookieOptions, setDefault) => {
        var _a, _b, _c, _d, _e, _f, _g;
        let cookieString = `${cookie.name}=${cookie.value}; `;
        const domain = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.domain) || ((_a = cookie.options) === null || _a === void 0 ? void 0 : _a.domain) || setDefault
            ? DefaultCookieOptions.domain
            : false;
        const path = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.path) || ((_b = cookie.options) === null || _b === void 0 ? void 0 : _b.path) || setDefault ? DefaultCookieOptions.path : false;
        const expires = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.expires) || ((_c = cookie.options) === null || _c === void 0 ? void 0 : _c.expires) || setDefault
            ? DefaultCookieOptions.expires
            : false;
        const maxAge = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.maxAge) || ((_d = cookie.options) === null || _d === void 0 ? void 0 : _d.maxAge) || setDefault
            ? DefaultCookieOptions.maxAge
            : false;
        const sameSite = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.sameSite) || ((_e = cookie.options) === null || _e === void 0 ? void 0 : _e.sameSite) || setDefault
            ? DefaultCookieOptions.sameSite
            : false;
        const httpOnly = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.httpOnly) || ((_f = cookie.options) === null || _f === void 0 ? void 0 : _f.httpOnly) || setDefault
            ? DefaultCookieOptions.httpOnly
            : false;
        const secure = (cookieOptions === null || cookieOptions === void 0 ? void 0 : cookieOptions.secure) || ((_g = cookie.options) === null || _g === void 0 ? void 0 : _g.secure) || setDefault
    ...
    class XSessionEventEmitter extends EventTarget {
        constructor() {
            super();
            this.__CLASSNAME__ = 'XSessionEventEmitter';
            this._listeners = {};
        }
        eventNames() {
        ...
        listener(e) {
            this._listeners[e.type].forEach((customListener) => {
                customListener(...e.detail.args);
            });
        }
        on(eventName, customListener) {
    ...
    class XSessionPushEvent extends XSessionEventEmitter {
        constructor(options) {
            super();
            this.__CLASSNAME__ = 'XSessionPushEvent';
        ...
        onopen(ev) {
            ...
            if (!this._reconnectIntervalId) {
                this._reconnectIntervalId = setInterval(this.reconnectCheck, this._options.reconnectInterval || DEFAULT_RECONNECT_INTERVAL);
            }
            this.emit('open', ev);
        }
        onerror(ev) {
            ...
            if (((_a = this._eventSource) === null || _a === void 0 ? void 0 : _a.readyState) === EventSource.CLOSED) {
                this.emit('close', ev);
            }
            else {
                this.emit('error', ev);
    ...
    class XSession extends XSessionPushEvent {
        ...
        getHttpHeaders(headers) {
            ...
            if (headers && headers.constructor.name === 'Headers') {
                ...
                throw new Error(`${this.__CLASSNAME__}::${__FUNCTION__} 'headers' in the param is not valid. It must be an instance of 'Headers' or 'Object'`);
            }
            return httpHeaders;
        }
        createXSession() {
            ...
            this._clientSessionId = node_crypto.randomUUID();
            const cookieValue = {
                status: 'new-session',
                clientSessionId: this._clientSessionId,
                payload: this._browserInfo,
            };
            const domainOrigin = getDomainFromUrl(((_a = this._browserInfo.windowLocation) === null || _a === void 0 ? void 0 : _a.origin) || 'localhost');
            document.cookie = getCookieString({ name: 'x-session-data', value: this.getJsonWebToken(cookieValue) }, this._cookieOptions
                ? getCookieOptions({
        ...
        getJsonWebToken(payload) {
            const token = jsonwebtoken.sign({ data: payload }, 'new-session', { algorithm: 'HS256' });
            return `ns${token}`;
        }
        config(options) {
            var _a;
            options.headers = this.getHttpHeaders(options.headers || new Headers());
            const headersInVolatile = ((_a = this._sessionOptionsVolatile) === null || _a === void 0 ? void 0 : _a.headers) || null;
            if (!this._sessionOptionsVolatile) {
                this._sessionOptionsVolatile = new Object();
                this._sessionOptionsVolatile = this._sessionOptions;
            }
            Object.entries(options).forEach(([key, value]) => {
                this._sessionOptionsVolatile[key] = value;
            });
            if (headersInVolatile)
                return this.setHeaders(headersInVolatile);
            return this;
        }
        setHeaders(headers) {
            var _a, _b, _c, _d;
            ...
            httpHeaders.forEach(([key, value]) => {
                var _a, _b;
                (_b = (_a = this._sessionOptionsVolatile) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b.append(key, value);
            });
            if (!((_b = (_a = this._sessionOptionsVolatile) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b.has('Content-Type'))) {
                (_d = (_c = this._sessionOptionsVolatile) === null || _c === void 0 ? void 0 : _c.headers) === null || _d === void 0 ? void 0 : _d.append('Content-Type', 'application/json');
            }
            return this;
        }
        send(msgTypeOrData, msgData) {
            return __awaiter(this, void 0, void 0, function* () {
                const __FUNCTION__ = 'send()';
                if (!this._sessionOptionsVolatile) {
                    throw new Error(`${this.__CLASSNAME__}::${__FUNCTION__} The session configuration is not set yet. call config() method first before send().`);
                }
...
})(crypto, buffer, stream, util, crypto);
